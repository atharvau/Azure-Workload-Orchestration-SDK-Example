...
function _listBySubscriptionSend(context, options = {
    ...
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/providers/Microsoft.Edge/solutionTemplates{?api%2Dversion}", {
...
async function _listBySubscriptionDeserialize(result) {
    ...
    return (0, models_js_1._solutionTemplateListResultDeserializer)(result.body);
}
...
function _listByResourceGroupSend(context, resourceGroupName, options = {
    ...
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutionTemplates{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
...
function _$deleteSend(context, resourceGroupName, solutionTemplateName, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutionTemplates/{solutionTemplateName}{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
 ...
 */
function $delete(context, resourceGroupName, solutionTemplateName, options = { requestOptions: {} }) {
    return (0, pollingHelpers_js_1.getLongRunningPoller)(context, _$deleteDeserialize, ["202", "204", "200"], {
        updateIntervalInMs: options?.updateIntervalInMs,
        abortSignal: options?.abortSignal,
        getInitialResponse: () => _$deleteSend(context, resourceGroupName, solutionTemplateName, options),
        resourceLocationConfig: "location",
    });
}
function _removeVersionSend(context, resourceGroupName, solutionTemplateName, body, options = {
    requestOptions: {},
}) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutionTemplates/{solutionTemplateName}/removeVersion{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
        solutionTemplateName: solutionTemplateName,
        "api%2Dversion": context.apiVersion,
...
function removeVersion(context, resourceGroupName, solutionTemplateName, body, options = {
    requestOptions: {},
}) {
    return (0, pollingHelpers_js_1.getLongRunningPoller)(context, _removeVersionDeserialize, ["202", "200"], {
        updateIntervalInMs: options?.updateIntervalInMs,
        abortSignal: options?.abortSignal,
        getInitialResponse: () => _removeVersionSend(context, resourceGroupName, solutionTemplateName, body, options),
        resourceLocationConfig: "location",
    });
}
function _createVersionSend(context, resourceGroupName, solutionTemplateName, body, options = {
    requestOptions: {},
}) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutionTemplates/{solutionTemplateName}/createVersion{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
        solutionTemplateName: solutionTemplateName,
        "api%2Dversion": context.apiVersion,
    ...
    return context.path(path).post({
        ...
        body: (0, models_js_1.solutionTemplateVersionWithUpdateTypeSerializer)(body),
    });
}
...
function createVersion(context, resourceGroupName, solutionTemplateName, body, options = {
    requestOptions: {},
}) {
    return (0, pollingHelpers_js_1.getLongRunningPoller)(context, _createVersionDeserialize, ["202", "200"], {
        updateIntervalInMs: options?.updateIntervalInMs,
        abortSignal: options?.abortSignal,
        getInitialResponse: () => _createVersionSend(context, resourceGroupName, solutionTemplateName, body, options),
        resourceLocationConfig: "location",
    });
}
function _updateSend(context, resourceGroupName, solutionTemplateName, properties, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutionTemplates/{solutionTemplateName}{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
        solutionTemplateName: solutionTemplateName,
    ...
    return context.path(path).patch({
        ...
        body: (0, models_js_1.solutionTemplateUpdateSerializer)(properties),
    });
}
async function _updateDeserialize(result) {
    ...
    return (0, models_js_1.solutionTemplateDeserializer)(result.body);
}
/** update a Solution Template Resource */
async function update(context, resourceGroupName, solutionTemplateName, properties, options = { requestOptions: {} }) {
    const result = await _updateSend(context, resourceGroupName, solutionTemplateName, properties, options);
    return _updateDeserialize(result);
}
function _createOrUpdateSend(context, resourceGroupName, solutionTemplateName, resource, options = {
    requestOptions: {},
}) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutionTemplates/{solutionTemplateName}{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
    ...
    return context.path(path).put({
        ...
        body: (0, models_js_1.solutionTemplateSerializer)(resource),
    });
}
...
function createOrUpdate(context, resourceGroupName, solutionTemplateName, resource, options = {
    requestOptions: {},
}) {
    return (0, pollingHelpers_js_1.getLongRunningPoller)(context, _createOrUpdateDeserialize, ["200", "201", "202"], {
        updateIntervalInMs: options?.updateIntervalInMs,
        abortSignal: options?.abortSignal,
        getInitialResponse: () => _createOrUpdateSend(context, resourceGroupName, solutionTemplateName, resource, options),
        resourceLocationConfig: "azure-async-operation",
    });
}
function _getSend(context, resourceGroupName, solutionTemplateName, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/solutionTemplates/{solutionTemplateName}{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
        solutionTemplateName: solutionTemplateName,
...
async function get(context, resourceGroupName, solutionTemplateName, options = { requestOptions: {} }) {
