...
function _listBySubscriptionSend(context, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/providers/Microsoft.Edge/diagnostics{?api%2Dversion}", {
...
async function _listBySubscriptionDeserialize(result) {
    ...
    return (0, models_js_1._diagnosticListResultDeserializer)(result.body);
}
...
function _listByResourceGroupSend(context, resourceGroupName, options = {
    ...
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/diagnostics{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
...
function _$deleteSend(context, resourceGroupName, diagnosticName, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/diagnostics/{diagnosticName}{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
 ...
 */
function $delete(context, resourceGroupName, diagnosticName, options = { requestOptions: {} }) {
...
function _updateSend(context, resourceGroupName, diagnosticName, properties, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/diagnostics/{diagnosticName}{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
        diagnosticName: diagnosticName,
    ...
    return context.path(path).patch({
        ...
        body: (0, models_js_1.diagnosticUpdateSerializer)(properties),
    });
}
async function _updateDeserialize(result) {
    ...
    return (0, models_js_1.diagnosticDeserializer)(result.body);
}
/** Updates existing Diagnostic resource. */
function update(context, resourceGroupName, diagnosticName, properties, options = { requestOptions: {} }) {
    return (0, pollingHelpers_js_1.getLongRunningPoller)(context, _updateDeserialize, ["200", "202"], {
        updateIntervalInMs: options?.updateIntervalInMs,
        abortSignal: options?.abortSignal,
        getInitialResponse: () => _updateSend(context, resourceGroupName, diagnosticName, properties, options),
        resourceLocationConfig: "location",
    });
}
function _createOrUpdateSend(context, resourceGroupName, diagnosticName, resource, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/diagnostics/{diagnosticName}{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
        diagnosticName: diagnosticName,
    ...
    return context.path(path).put({
        ...
        body: (0, models_js_1.diagnosticSerializer)(resource),
    });
}
...
function createOrUpdate(context, resourceGroupName, diagnosticName, resource, options = { requestOptions: {} }) {
    return (0, pollingHelpers_js_1.getLongRunningPoller)(context, _createOrUpdateDeserialize, ["200", "201", "202"], {
        updateIntervalInMs: options?.updateIntervalInMs,
        abortSignal: options?.abortSignal,
        getInitialResponse: () => _createOrUpdateSend(context, resourceGroupName, diagnosticName, resource, options),
        resourceLocationConfig: "azure-async-operation",
    });
}
function _getSend(context, resourceGroupName, diagnosticName, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/diagnostics/{diagnosticName}{?api%2Dversion}", {
        subscriptionId: context.subscriptionId,
        resourceGroupName: resourceGroupName,
        diagnosticName: diagnosticName,
...
async function get(context, resourceGroupName, diagnosticName, options = { requestOptions: {} }) {
