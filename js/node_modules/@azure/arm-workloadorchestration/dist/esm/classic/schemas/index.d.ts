...
import { SchemasListBySubscriptionOptionalParams, SchemasListByResourceGroupOptionalParams, SchemasRemoveVersionOptionalParams, SchemasCreateVersionOptionalParams, SchemasDeleteOptionalParams, SchemasUpdateOptionalParams, SchemasCreateOrUpdateOptionalParams, SchemasGetOptionalParams } from "../../api/schemas/options.js";
import { Schema, SchemaUpdate, SchemaVersionWithUpdateType, SchemaVersion, VersionParameter, RemoveVersionResponse } from "../../models/models.js";
...
export declare function _getSchemasOperations(context: WorkloadOrchestrationManagementContext): SchemasOperations;
